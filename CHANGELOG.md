...
#### `firestore_odm_builder` - `v4.0.0-dev.1`
...
Packages with other changes:
 ...
 - [`firestore_odm_builder` - `v4.0.0-dev`](#firestore_odm_builder---v400-dev)

---

#### `firestore_odm_builder` - `v4.0.0-dev`

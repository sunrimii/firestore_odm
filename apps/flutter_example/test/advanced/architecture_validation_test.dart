...
void main() {
  group('🏗️ Architecture Validation', () {
    ...
    group('📋 Schema Analysis & Collection Processing', () {
      ...
      test(
        'should validate collection relationships are correctly processed',
        () {
          ...
          expect(
            userDoc.sharedPosts.query.path,
          ...
          expect(
            ...
            isA<
              FirestoreCollection<
                ...
                SimpleStory,
                dynamic,
                SimpleStoryPatchBuilder<SimpleStory>,
    ...
    group('⚡ High-Efficiency Generation Validation', () {
      test(
        'should validate converters work efficiently across all models',
        () async {
          ...
          final retrievedStory = await odm
              .simpleStories('converter_test_story')
              .get();
          final retrievedShared = await odm
              .sharedPosts('converter_test_shared')
              .get();
      ...
      test(
        'should validate no runtime data collection during operations',
        () async {
          ...
          expect(
            operationTime,
            lessThan(15000),
          ); // 15 seconds max for 40 operations
    ...
    group('🔗 Collection Type Mapping & Schema Integration', () {
      test(
        'should validate consistent type mapping across collections',
        () async {
      ...
      test('should validate schema-level conflict detection works', () {
        ...
        expect(
          odm.users('test').sharedPosts.query.path,
    ...
    group('🚀 Scalability & Extensibility', () {
      test(
        'should validate system handles all model types efficiently',
        () async {
          ...
          final retrievedStory = await odm
              .simpleStories('scalability_story')
              .get();
          final retrievedShared = await odm
              .sharedPosts('scalability_shared')
              .get();
      ...
      test('should validate performance remains consistent', () async {
        ...
        for (int i = 0; i < 10; i++) {
          operations.addAll([
            ...
            odm
                .simpleStories('perf_test_story_$i')
                .update(
                  SimpleStory(

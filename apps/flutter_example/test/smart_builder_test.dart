...
void main() {
  group('🧠 Smart Builder Value Extraction Tests', () {
    ...
    test(
      'demonstrates smart builder reuse for single field extraction',
      () async {
    ...
    test(
      'demonstrates smart builder reuse for multiple fields extraction',
      () async {
    ...
    test('demonstrates mixed builder usage patterns', () async {
      ...
      final objectQuery = query.startAfterObject(
        sampleUser,
      ); // Object extraction

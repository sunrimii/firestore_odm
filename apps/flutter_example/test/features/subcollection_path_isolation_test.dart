...
void main() {
  group('Subcollection Path Isolation Bug Test', () {
    ...
    test('FINAL VERIFICATION: bug completely fixed', () {
      ...
      expect(users1.runtimeType.toString(), equals('FirestoreDocument<TestSchema, User, (_\$UsersCollection)>'));
      expect(users2_1.runtimeType.toString(), equals('FirestoreDocument<TestSchema, User, (_\$Users2Collection)>'));
      expect(posts1.runtimeType.toString(), equals('FirestoreDocument<TestSchema, Post, (_\$PostsCollection)>'));

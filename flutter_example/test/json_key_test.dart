...
void main() {
  group('🔑 JsonKey Annotation Tests', () {
    ...
    test('should rename fields using @JsonKey(name) annotation', () async {
      ...
      print('   isPremium -> is_premium_member: ${rawData['is_premium_member']}');
      print('   rating -> account_rating: ${rawData['account_rating']}');
    });

    test('should ignore fields with @JsonKey(includeFromJson: false, includeToJson: false)', () async {
      ...
      expect(rawData.containsKey('secretField'), isFalse,
    ...
    test('should retrieve and deserialize JsonKey user correctly', () async {
      ...
      expect(retrievedUser.secretField, isNull,
    ...
    test('should handle JsonKey annotations in queries', () async {
      ...
      print('   Young users: ${youngUsers.map((u) => '${u.name} (${u.age})').join(', ')}');
    });
  });
}
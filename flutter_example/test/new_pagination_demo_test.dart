...
void main() {
  group('New Strongly-Typed Pagination Tuple Syntax', () {
    ...
    test('demonstrates object-based pagination with automatic cursor extraction', () {
      ...
      final multiQuery = odm.users
          ...
          .endBeforeObject(sampleUser);           // Should extract (30, 4.3) automatically
    ...
    test('demonstrates type safety - compilation should catch type mismatches', () {
      ...
      final query = odm.users
          .orderBy(($) => ($.age(), $.rating()));  // (int, double) tuple expected

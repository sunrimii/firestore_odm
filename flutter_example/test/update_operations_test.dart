  ...
  group('Update Operations Tests', () {
    ...
    group('🔄 Array-Style Update API', () {
      ...
      test('should perform numeric increment operations', () async {
        ...
        await userDoc.update(($) => [
          $.age.increment(1), // age: 25 + 1 = 26
          $.rating.increment(0.5), // rating: 3.0 + 0.5 = 3.5
          $.profile.followers.increment(50), // followers: 100 + 50 = 150
          $(
            age: 21,
      ...
      test('should handle object merge operations', () async {
        ...
        await userDoc.update(($) => [
          ...
          $.profile(bio: 'Good developer', followers: 200),
        ]);
      ...
      test('should handle complex mixed operations', () async {
        ...
        await userDoc.update(($) => [
          ...
          $.profile.followers.increment(1), // Another increment
          $.rating.increment(0.1),
          $.tags.add('popular'),
          $.profile.lastActive(DateTime.now()),
          $(name: 'Kyle'), // This will override the earlier name change
          $.profile(bio: 'Good'), // This will override the earlier bio change
        ]);
    ...
    group('⚡ Edge Cases & Error Handling', () {
      test('should handle concurrent updates gracefully', () async {
        ...
        final futures = [
          ...
          userDoc.update(($) => [
            $.profile.followers.increment(19)
          ]),
        ];

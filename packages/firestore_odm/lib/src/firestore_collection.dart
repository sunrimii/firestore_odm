...
class FirestoreCollection<S extends FirestoreSchema, T>
  ...
  FirestoreDocument<S, T> call(String id) =>
      FirestoreDocument(query.doc(id), toJson, fromJson, documentIdField);

  /// Upsert a document using the id field as document ID
  Future<void> upsert(T value) =>
      CollectionHandler.upsert(query, value, toJson, documentIdField);
  ...
  Future<void> insert(T value) =>
      CollectionHandler.insert(query, value, toJson, documentIdField);

  /// Update an existing document using the id field as document ID
  /// Fails if document doesn't exist
  @override
  Future<void> update(T value) =>
      CollectionHandler.update(query, value, toJson, documentIdField);

  @override
  Future<List<T>> get() =>
      CollectionHandler.get<T>(query, fromJson, documentIdField);

  @override
  Stream<List<T>> get stream =>
      QueryHandler.stream(query, fromJson, documentIdField);
  ...
  OrderedQuery<S, T, O> orderBy<O extends Record>(
    ...
    return OrderedQuery(newQuery, toJson, fromJson, documentIdField, config);
  }
  ...
  Query<S, T> where(FilterBuilder<T> filterBuilder) {
    ...
    return Query<S, T>(newQuery, toJson, fromJson, documentIdField);
  }
  ...
  Future<void> patch(PatchBuilder<T> patchBuilder) =>
      QueryHandler.patch(query, documentIdField, patchBuilder);
  ...
  AggregateQuery<S, T, R> aggregate<R extends Record>(
    ...
    return AggregateQuery(newQuery, toJson, fromJson, documentIdField, config);
  }
  ...
  Future<void> modify(ModifierBuilder<T> modifier, {bool atomic = true}) =>
      QueryHandler.modify(query, documentIdField, toJson, fromJson, modifier, atomic: atomic);
